...
\begin{tabular}{c|l}
      ...
      avg fail dif    & average value of $f(x)-f(opt)$ for non-optimal solutions        \\ \hline
...
$H_1$ in this case then is: the algorithm once the left is better than algorithm on the right.
