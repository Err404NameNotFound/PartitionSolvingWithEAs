...
In a previous chapter the $\mathcal{O}(nlogn)$ bound was proven for the (1+1) EA and the RLS (Theorem~\ref{theo:OneMaxResult}).
...
This input is harder because switching multiple small values for a big value increases the fitness but increases the Theorem~\ref{theo:OneMaxResult} to the optimum.
