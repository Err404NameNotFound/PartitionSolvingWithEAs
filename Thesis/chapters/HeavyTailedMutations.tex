...
% \begin{lemma}
%       The (1+1) EA with mutation rate $p_m=c/n$ for any constant $c>0$ optimises any input with $w_1>W/2$ in expected at most $(2en\ln~n+4) + (1+o(1))(e^c/c)n\ln~n = \Theta(n\log{}n)$
% \end{lemma}
% \begin{proof}
%       The proof is mostly the same as for the (1+1) EA with static mutation rate $1/n$ in~\ref{theo:OneMaxResult}.
% \end{proof}