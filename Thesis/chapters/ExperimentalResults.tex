...
\begin{table}[t]
      ...
      \begin{tabular}{m{2.5cm}m{2cm}m{2cm}m{0.5cm}m{0.5cm}m{0.5cm}m{0.5cm}m{1cm}m{1cm}}\label{table:BestAlgoVariantTable}
            $n$             & \multicolumn{2}{|c}{$100$}
                            & \multicolumn{2}{c}{$500$}
                            & \multicolumn{2}{c}{$1000$}
                            & \multicolumn{2}{c}{$50,000$}                                                                                      \\
            \hline
            geometric       & \multicolumn{5}{|c|}{(1+1) EA $_{2/n}$}            & \multicolumn{2}{c|}{$pmut_{3.25}$} & RLS                     \\
            \hline
            binomial        & \multicolumn{3}{|c|}{(1+1) EA $_{3/n}$}            & \multicolumn{5}{c}{\RLSN[2]}                                 \\
            uniform         & \multicolumn{3}{|c|}{(1+1) EA $_{4/n}$}            & \multicolumn{5}{c}{\RLSN[2]}                                 \\
            \hline
            powerlaw        & \multicolumn{8}{|c}{$pmut_{1.5}$ or $pmut_{1.75}$}                                                                \\
            linear function & \multicolumn{8}{|c}{RLS}                                                                                          \\
            worst case      & \multicolumn{8}{|c}{$pmut_{1.25}$}                                                                                \\
            \hline
            combined        & \multicolumn{1}{|c|}{(1+1) EA $_{2/n}$}            & \multicolumn{4}{c|}{$pmut_{3.0}$}  & \multicolumn{3}{c}{RLS} \\
                            &                                                    &                                    &
                            &                                                    &                                    &
                            &                                                    &                                                              \\
      \end{tabular}
