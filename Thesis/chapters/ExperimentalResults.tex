...
That's why for $m \in \{10,100,1000\}$ there is one figure for the even input sizes $n$ and one for the uneven. 
For $n\ge10,000$ all values for the uneven input sizes are 0 \%, so there is no point in showing the data in a separate graph. The lines in the separate graphs for even and uneven $n$ are only to visualise the growth in $n$. The displayed values in between the listed input sizes on the x-axis do not have a meaning.\newline
...
For uniform distributed inputs Borgs \emph{et. al.} showed that the coefficient of \#bits needed to encode the max value/$n$ has a huge impact on the number of perfect partitions~\cite{borgs2001phase}.
...
\begin{figure}[h]
      ...
      \hspace{0.75cm}
      \begin{minipage}[b]{0.45\textwidth}
            \caption{Percentage of Binomial inputs with perfect partitions for $m = 10$ for uneven $n$}
...
\begin{figure}[h]
      ...
      \hspace{0.75cm}
      \begin{minipage}[b]{0.45\textwidth}
            \caption{Percentage of Binomial inputs with perfect partitions for $m = 100$ for uneven $n$}
...
\begin{figure}[h]
      ...
      \hspace{0.75cm}
      \begin{minipage}[b]{0.45\textwidth}
            \caption{Percentage of Binomial inputs with perfect partitions for $m = 1000$ for uneven $n$}
